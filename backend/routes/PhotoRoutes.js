...
const { photoInsertValidation, photoUpdateVaidation, commentValidation } = require("../middlewares/photoValidation");
...
router.put("/:id", authGuard, photoUpdateVaidation(), validate, updatePhoto);
